...
for(const needle of ["Seguimiento WIPO.","Escribe qué seguir","VIDENTIA lo conecta","Recibe novedades","Activar seguimiento","No necesitas crear enlaces, copiar RSS ni validar fuentes","VIDENTIA_WIPO_CONNECT",'params.get("feedUrl")','params.get("nonce")',"crypto.randomUUID()","window.localStorage.setItem","readPendingAutomaticConnection","window.localStorage.removeItem",'href="/monitorear"',"Revisar ahora","Tus seguimientos","Seguimiento activo","Pausar","Reactivar","Eliminar","Detalles técnicos",'/patentes/wipo/conector'])requireText(page,needle,"automatic WIPO UI")
