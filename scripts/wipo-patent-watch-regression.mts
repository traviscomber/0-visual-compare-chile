...
for(const needle of ["WIPO en 3 pasos.","Conecta","VIDENTIA monitorea","Revisa novedades","No tienes que volver a hacer nada.","Ver novedades",'href="/monitorear"',"Revisar ahora",'method:"PUT"',"Tus seguimientos","Activo","Pausado","Pausar","Reactivar","Eliminar","Detalles técnicos","RSS oficial","Empieza en el paso 1.","Paso 1","Sólo una vez","A","Abre tu consulta guardada","B","Pega el RSS","C","Activa el seguimiento","WIPO_SAVED_QUERIES_URL","Abrir WIPO","Pega aquí la URL RSS de PATENTSCOPE","Validar","Activar seguimiento","navigator.clipboard.writeText"])requireText(page,needle,"WIPO UI")
...
console.log("WIPO patent watch regression PASS: the UI is a simple 1-2-3 product flow with an A-B-C connection guide, persistent automatic tracking remains the product behavior, manual refresh stays optional, and PATENTSCOPE provenance, baseline suppression, degraded-source semantics and no legal-status inference remain intact.")
