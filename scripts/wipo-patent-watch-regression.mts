...
for(const needle of ["requireUser()","source_type",'"wipo_patentscope_rss"',"source_url","source_status","fetchWipoPatentScopeRss","source_last_checked_at: null","last_checked_at: null","baseline: \"existing_items_will_be_marked_reviewed\""])requireText(watches,needle,"WIPO watches API")
if(watches.includes("source_last_checked_at: now")||watches.includes("last_checked_at: now"))fail("new or recreated WIPO watches must remain uncheckpointed until the cron establishes the baseline")
