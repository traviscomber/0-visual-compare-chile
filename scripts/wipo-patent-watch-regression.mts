...
for(const needle of ["PATENTSCOPE como fuente internacional observable","Private Query desmarcado","Validar RSS","Polling cada 6 h","No usa cookies de tu sesión","Sin inferencia jurídica","Consultar ahora",'method:"PUT"',"Baseline pendiente","Fuentes verificadas","Con checkpoint de polling"])requireText(page,needle,"WIPO UI")
