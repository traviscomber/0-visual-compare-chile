...
import { Activity, BarChart3, Bell, BellRing, Bot, BriefcaseBusiness, ClipboardCheck, History, LayoutDashboard, LogOut, Menu, Radar, Search, Settings, Terminal, Waypoints } from "lucide-react"
...
const navItems = [
  ...
  { href: "/monitorear", label: "Vigilar", icon: BellRing, aliases: ["/patentes/alertas"] },
]
