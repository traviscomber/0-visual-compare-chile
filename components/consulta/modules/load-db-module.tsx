 ...
 * Pensado para importaciones controladas de piloto y archivos de prueba.
 */
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-400 mt-1">
          Importa archivos controlados para el piloto
        </p>
      </div>
        ...
        <div className="space-y-6">
          <div className="relative">
            <input
              ...
              id="db-upload"
            />
            <label htmlFor="db-upload" className="block cursor-pointer">
              <div className="border-2 border-dashed border-slate-600 rounded-lg p-12 text-center hover:border-blue-500 hover:bg-blue-500/5 transition">
                ...
                <p className="text-sm text-slate-500">
                  CSV o JSON para importaciones de piloto
                </p>
              </div>
            </label>
          </div>
          ...
          <div className="bg-slate-700/30 rounded-lg p-4 text-sm text-slate-300">
            ...
            <ul className="space-y-1 text-slate-400">
              ...
              <li>• Importación controlada para piloto</li>
            </ul>
          </div>
        </div>
      </Card>
