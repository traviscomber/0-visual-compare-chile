...
- Las rutas públicas `/`, `/demo`, `/contacto`, `/privacidad` y `/terminos` se auditan por status HTTP, H1 único, landmark `main`, IDs únicos, ausencia de controles interactivos anidados y overflow horizontal en desktop/mobile.
