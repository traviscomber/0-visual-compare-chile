...
export async function GET(request: NextRequest) {
  ...
  const response = await fetch(new URL("/api/v1/public/trademark-preview", request.url), {
    ...
    headers: {
      ...
      "User-Agent": "videntia-production-smoke/1.0",
    },
  ...
  const evidencia = body.evidencia && typeof body.evidencia === "object"
    ? body.evidencia as Record<string, unknown>
    : {}
  const busqueda = body.busqueda && typeof body.busqueda === "object"
    ? body.busqueda as Record<string, unknown>
    : {}
