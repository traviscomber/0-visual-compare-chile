...
const structuredData = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      featureList: ["Búsqueda de antecedentes marcarios", "Análisis denominativo y fonético", "Análisis visual", "Clases Niza", "Clasificación de Viena", "Precedentes TDPI", "Vigilancia de marcas", "Casos y evidencia"],
    },
    {
      "@type": "FAQPage",
      ...
      <section className="relative overflow-hidden border-b border-black/10 px-5 pb-24 pt-36 lg:px-10 lg:pb-32 lg:pt-44">
        ...
        <div className="relative mx-auto grid max-w-[1480px] gap-16 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div className="max-w-3xl">
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row"><Link href="/demo"><Button size="lg" className="h-12 gap-2 rounded-lg bg-[#0F766E] px-6 text-white shadow-none hover:bg-[#134E4A]">Analizar una marca <ArrowRight className="h-4 w-4" /></Button></Link><Link href="#como-funciona"><Button size="lg" variant="outline" className="h-12 rounded-lg border-black/15 bg-transparent px-6 hover:bg-black/5">Ver el método</Button></Link></div>
