...
import { AlertTriangle, ArrowRight, CheckCircle2, ImageIcon, Layers3, Loader2, Search, ShieldAlert, Sparkles, Upload } from "lucide-react"
...
export default function DemoPage() {
  ...
  const handleFile = (file: File) => {
    ...
    reader.onload = () => {
      ...
      setImage(value); setImagePreview(value)
    }
  ...
  return <main className="min-h-screen bg-slate-950 text-white">
    ...
    <section className="px-5 py-14 lg:px-8 lg:py-20"><div className="mx-auto max-w-7xl">
      <div className="max-w-4xl"><div className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1.5 text-sm text-slate-300"><Sparkles className="h-4 w-4 text-blue-300" /> Prueba real · sin cuenta</div><h1 className="text-5xl font-semibold tracking-[-0.04em] sm:text-6xl">Danos la marca. <span className="text-blue-300">Nosotros construimos la búsqueda.</span></h1><p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">No necesitas decidir si buscar exacto, por contenido, por variante o por elemento dominante. Visual Compare prueba estrategias útiles, elimina duplicados y te devuelve lo que merece atención.</p></div>
