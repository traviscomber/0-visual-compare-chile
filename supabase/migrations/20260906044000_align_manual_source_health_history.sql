...
begin
  ...
  return jsonb_build_object('ok', true, 'context', coalesce(nullif(trim(p_context), ''), 'scheduled'),
    'snapshots', v_snapshots, 'alertsOpened', v_opened, 'alertsResolved', v_resolved, 'ranAt', now());
end;
$function$;
